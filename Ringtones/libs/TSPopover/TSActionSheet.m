...
- (id)initWithTitle:(NSString *)title 
{
    if ((self = [super init]))
    {
        ...
        self.buttonGradient = NO;
        self.titleShadow = NO;
        self.titleColor = [UIColor blackColor];
        self.titleShadowOffset = TITLE_SHADOW_OFFSET;
        self.titleShadowColor = [UIColor colorWithRed:(228/255.0) green:(227/255.0) blue:(227/255.0) alpha:1];
        
        popoverController = [[TSPopoverController alloc] init];
        popoverController.titleText = title;
        popoverController.titleFont =[UIFont fontWithName:@"Helvetica-5-Normal" size:18];
...
- (void)addButtonWithTitle:(NSString *)title block:(void (^)())block 
{
    [self addButtonWithTitle:title
                       color:[UIColor colorWithRed:(228/255.0) green:(227/255.0) blue:(227/255.0) alpha:1]
...
{
    [self addButtonWithTitle:title
                       color:[UIColor colorWithRed:(67/255.0) green:(149/255.0) blue:(200/255.0) alpha:1]
                  titleColor:[UIColor  blackColor]
                 borderWidth:0
                 borderColor:[UIColor blackColor]
                       block:block];
...
- (void) buildButtons
{
    ...
    for (NSArray *button in buttonsMutableArray)
    {
        ...
        button.titleLabel.font = [UIFont fontWithName:@"Helvetica-5-Normal" size:16];
